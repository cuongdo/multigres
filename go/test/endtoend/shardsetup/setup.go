...
type SetupConfig struct {
	...
	S3BackupEndpoint                    string // S3 endpoint (empty = use AWS, otherwise MinIO/custom)
}
...
// WithS3Backup configures S3/MinIO backup storage instead of filesystem.
// Environment variables must be set:
//   - AWS_ACCESS_KEY_ID
//   - AWS_SECRET_ACCESS_KEY
//
// For MinIO, also set MULTIGRES_MINIO_ENDPOINT (e.g., "https://localhost:9000")
